...
const questions = [
    ...
    { type: 'editor', name: 'technologies', message: "List the technologies used (one entry per line) This will open and external editor. Save and close editor when finished.:" },
